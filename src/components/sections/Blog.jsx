            ...
            <div className="blog-grid">
                ...
                <article className="blog-card">
                    <div className="blog-thumb">
                        <img src="https://placehold.co/600x300/1e293b/ffffff?text=Java+30" alt="Java at 30 article thumbnail" />
                    </div>
                ...
                <article className="blog-card">
                    <div className="blog-thumb">
                        <img src="https://placehold.co/600x300/1e293b/ffffff?text=Pay+Per+Crawl" alt="Cloudflare Pay-Per-Crawl article thumbnail" />
                    </div>
                    <div className="blog-info">
                ...
                <article className="blog-card">
                    <div className="blog-thumb">
                        <img src="https://placehold.co/600x300/1e293b/ffffff?text=Git+20" alt="Git 20 article thumbnail" />
                    </div>
                    <div className="blog-info">
